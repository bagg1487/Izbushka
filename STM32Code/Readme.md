...
### Способ 1: Работа с уже сгенерированным проектом

Этот способ подходит, когда проект уже сгенерирован через CubeMX (есть папка MDK-ARM с файлом .uvprojx). Не нужно нажимать GENERATE CODE.
 
- Запускаем Keil uVision

- Переходим в Project → Open Project

- В окне выбора файла переходим в папку проекта → MDK-ARM

- Выбираем файл с расширением .uvprojx или .uvproj

Открывается Проект в котором вы можете редактировать код.

### Способ 2: Создание сгенерированного проекта с помощью **STM32CubeMX**
