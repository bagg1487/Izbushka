...
uint8_t MPU6050_Init(uint32_t MPU6050_ADDR, I2C_HandleTypeDef *I2Cx)
{ 
		//MPU6050_ADDR = MPU6050_ADDR_num;
    uint8_t check = 0;
    uint8_t Data;
...
void MPU6050_Read_Temp(uint32_t MPU6050_ADDR_num, I2C_HandleTypeDef *I2Cx, MPU6050_t *DataStruct)
{
    ...
    HAL_I2C_Mem_Read(I2Cx, MPU6050_ADDR_num, TEMP_OUT_H_REG, 1, Rec_Data, 2, i2c_timeout);
...
void MPU6050_Read_All(uint32_t MPU6050_ADDR_num, I2C_HandleTypeDef *I2Cx, MPU6050_t *DataStruct)
{
    ...
    HAL_I2C_Mem_Read(I2Cx, MPU6050_ADDR_num, ACCEL_XOUT_H_REG, 1, Rec_Data, 14, i2c_timeout);
...
double Kalman_getAngle(Kalman_t *Kalman, double newAngle, double newRate, double dt)
{
    ...
    double S = Kalman->P[0][0] + R_measure;
    double K[2];
    K[0] = Kalman->P[0][0] / S;
    K[1] = Kalman->P[1][0] / S;
