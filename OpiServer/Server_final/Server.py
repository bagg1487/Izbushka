...
class Server:
    def __init__(self, outside_layout):
        ...
        self.service = Service(self.uart)
            ...
            try:
                ...
                for oneCmd in cmdArray:
                    ...
                    if cmd.CMD_SONIC in data:
                        ...
                        self.service.start_radio()
                    elif cmd.CMD_RADIO_STOP in data:
                        self.service.stop_radio()

                    elif cmd.CMD_MENU in data:
                        self.service.stop_radio()
                        self.service.stop_music()
                        self.service.stop_video()
