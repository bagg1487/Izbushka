...
from PyQt5.QtCore import pyqtSignal, Qt, QTimer, QEvent, QSize
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        self.server.service.video_player.setParent(self.centralwidget)
    ...
    def on_and_off_server(self):
        ...
        if self.pushButton.text() == 'On':
            self.timer_hold_3.start(180000)
            self.timer_hold_10.start(600000)
            # Устанавливаем текст кнопки в 'OFF_DEMO'
            ...
            # Устанавливаем текст кнопки в 'ON_DEMO'
