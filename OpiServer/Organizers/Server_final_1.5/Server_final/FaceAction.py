...
class FaceAction:
    ...
    def add_user(self, rec):
        ...
        """
        self.speach_rec.speak('Назовите имя пользователя')
        ...
        while True:
            ...
            if not trig_name:  # Если флаг trig_name установлен в False
                ...
                if 'да' in query:  # Если в ответе есть слово "да"
                    self.speach_rec.speak('В течении 10 секунд изменяйте положение головы, принимая различные позы.')
